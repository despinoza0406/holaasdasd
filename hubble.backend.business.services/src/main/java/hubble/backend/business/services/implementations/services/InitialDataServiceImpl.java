...
public class InitialDataServiceImpl implements InitialDataService {
    ...
    private static ApplicationStorage createApplicationStorage(String id, String nombre, String descripcion, List<Threashold> th, String nombreEnBSM, String nombreEnPPM, String nombreEnALM, String nombreEnJira, String projectKeyEnJira, String nombreEnSiteScope, String nombreEnAppPulse) {
        return new ApplicationStorage(
                ...
                true,
                new KPIs(
                        new Tasks(true, th.get(0), th.get(0), th.get(0), th.get(4),ApplicationInProvider.standard(nombreEnPPM, Boolean.TRUE)),
                        ...
                        new Availavility(true, th.get(1), th.get(1), th.get(1), th.get(1), ApplicationInProvider.standard(nombreEnBSM, Boolean.TRUE), ApplicationInProvider.standard(nombreEnAppPulse, Boolean.TRUE)),
                        new Performance(true, th.get(2), th.get(2), th.get(2), th.get(2), th.get(5), ApplicationInProvider.standard(nombreEnAppPulse, Boolean.TRUE), ApplicationInProvider.standard(nombreEnAppPulse, Boolean.TRUE)),
    ...
    private List<Threashold> crearThreasholds() {
        ...
        threasholds.add(new Threashold(0, 1, 4, Double.POSITIVE_INFINITY));//Tasks Unitary
        threasholds.add(new Threashold(0, 4000, 8000, Double.POSITIVE_INFINITY)); //Performance Unitary
